...
export const optionsConstants = {
    ...
    resultStatus: [
        { label: <div>success <CheckCircleFilled style={{ marginLeft: '5px', color: "#52c41a" }} /></div>, value: 1 },
    ...
    publishStatus: [
        ...
        {
            label: <div><CheckOutlined style={{ marginRight: '5px', color: "#52c41a" }} />SUCCESS</div>,
            value: 'SUCCESS'
        },
        {
